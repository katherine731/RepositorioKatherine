namespace Conexion
{
    public class Conexion
    {
      ...
      //  private static string CadenaConexion = @"Provider=SQLoledb;Server=(local);Database=planilla;Uid=sa;Pwd=*;";       
        private static string CadenaConexion = @"Provider=SQLoledb;Server=KITTY\SQLSERVER2008;Database=planilla;Uid=sa;Pwd=.;";	
